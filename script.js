...
const SVG_ICONS = {
  ...
  'svg:box':        `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#0061D5"/><text x="50" y="66" text-anchor="middle" font-family="'Arial Black',Arial,sans-serif" font-weight="900" font-size="36" fill="white">Box</text></svg>`,
  'svg:teams':      `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#5059C9"/><circle cx="62" cy="32" r="12" fill="rgba(255,255,255,0.85)"/><rect x="45" y="46" width="34" height="24" rx="7" fill="rgba(255,255,255,0.85)"/><circle cx="37" cy="38" r="17" fill="white"/><rect x="13" y="57" width="38" height="27" rx="8" fill="white"/></svg>`,
  'svg:onedrive':   `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#0078D4"/><path d="M14 74Q26 52 44 58Q50 38 66 41Q84 44 84 62Q94 60 92 73Q90 82 78 80H22Q6 82 14 74Z" fill="white"/></svg>`,
  'svg:sharepoint': `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#038387"/><circle cx="44" cy="44" r="28" fill="#1EB8BB"/><circle cx="60" cy="60" r="20" fill="#036B6E" opacity="0.95"/><circle cx="44" cy="44" r="17" fill="white"/><text x="44" y="51" text-anchor="middle" font-family="Arial,sans-serif" font-weight="900" font-size="20" fill="#038387">S</text></svg>`,
  'svg:dropbox':    `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#0061FF"/><path d="M50 18L23 34l27 17 27-17zM23 68l27 17 27-17-27-17zM23 34L10 44l13 8 27-17zM77 34l-13 8 13 8 13-8z" fill="white"/><path d="M37 72l13 8 13-8" fill="white"/></svg>`,
  'svg:zoom':       `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#2D8CFF"/><rect x="11" y="34" width="52" height="36" rx="9" fill="white"/><polygon points="65,39 87,27 87,73 65,61" fill="white"/></svg>`,
  'svg:github':     `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#24292F"/><path d="M50 14a36 36 0 00-11.4 70.1c1.8.3 2.4-.8 2.4-1.7v-5.9c-10 2.1-12.1-4.8-12.1-4.8-1.6-4.1-4-5.2-4-5.2-3.3-2.3.2-2.2.2-2.2 3.7.3 5.6 3.8 5.6 3.8 3.2 5.5 8.5 3.9 10.5 3 .3-2.3 1.2-3.9 2.3-4.8-8-.9-16.4-4-16.4-17.9 0-3.9 1.4-7.2 3.7-9.7-.4-.9-1.6-4.6.4-9.5 0 0 3-1 9.9 3.7a34.7 34.7 0 0118 0c6.9-4.7 9.9-3.7 9.9-3.7 2 4.9.7 8.6.4 9.5 2.3 2.5 3.7 5.8 3.7 9.7 0 13.9-8.4 17-16.5 17.9 1.3 1.1 2.4 3.4 2.4 6.8v10.1c0 1 .6 2.1 2.4 1.7A36 36 0 0050 14z" fill="white"/></svg>`,
  'svg:kintone':    `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#E02236"/><line x1="34" y1="22" x2="34" y2="78" stroke="white" stroke-width="10" stroke-linecap="round"/><line x1="34" y1="50" x2="66" y2="22" stroke="white" stroke-width="10" stroke-linecap="round"/><line x1="34" y1="50" x2="68" y2="78" stroke="white" stroke-width="10" stroke-linecap="round"/></svg>`,
  'svg:trello':     `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="#0052CC"/><rect x="14" y="18" width="30" height="46" rx="5" fill="white"/><rect x="56" y="18" width="30" height="30" rx="5" fill="white"/></svg>`,
  'svg:gmail':      `<svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" rx="20" fill="white"/><path d="M10 26h80v52H10z" fill="#4285F4"/><polygon points="10,26 50,56 90,26 90,32 50,62 10,32" fill="#EA4335"/><polygon points="10,26 10,78 28,60 10,26" fill="#34A853"/><polygon points="90,26 90,78 72,60 90,26" fill="#FBBC04"/></svg>`
};
